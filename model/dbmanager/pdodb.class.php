...
class DB
{
	...
	*/
		private function Connect()
		{
			...
			$dsn = 'mysql:dbname='.$this->settings["DATABASE"].';host='.$this->settings["DB_HOST_NAME"].'';
			try 
			{
				# Read settings from INI file
				$this->pdo = new PDO($dsn, $this->settings["DB_USER_NAME"], $this->settings["DB_PASSWORD"]);
